const GeoLayout castle_grounds_area_1_Level[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_ANIMATED_PART(1, -9, 35, 34, NULL),
			GEO_OPEN_NODE(),
				GEO_ANIMATED_PART(1, 9, -71, 30, castle_grounds_main_mesh),
				GEO_ANIMATED_PART(4, 9, -71, 30, castle_grounds_main_001_mesh),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
...
const GeoLayout castle_grounds_area_1_level[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_CAMERA(1, -9, 35, 34, -9, 32, 34, geo_camera_main),
				GEO_OPEN_NODE(),
