const GeoLayout bob_area_1_Level[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_ANIMATED_PART(1, 0, 0, 0, NULL),
			GEO_OPEN_NODE(),
				GEO_ANIMATED_PART(1, 0, 0, 0, bob_1_mesh),
				GEO_ANIMATED_PART(1, 0, 0, 0, bob_2_mesh),
				GEO_ANIMATED_PART(1, 0, 0, 0, bob_3_mesh),
				GEO_ANIMATED_PART(1, 0, 0, 0, bob_4_mesh),
				GEO_ANIMATED_PART(1, 0, 0, 0, bob_5050_mesh),
				GEO_ANIMATED_PART(1, 0, 0, 0, bob_audience_mesh),
				GEO_ANIMATED_PART(1, 0, 0, 0, bob_main_scrolling_mesh),
				GEO_ANIMATED_PART(4, 0, 0, 0, bob_main_static_alpha_mesh),
				GEO_ANIMATED_PART(1, 0, 0, 0, bob_main_static_mesh),
				GEO_ANIMATED_PART(1, 0, 0, 0, bob_phone_mesh),
				GEO_ANIMATED_PART(1, 0, 0, 0, bob_w1_mesh),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
...
const GeoLayout bob_area_1_level[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			...
			GEO_OPEN_NODE(),
				GEO_CAMERA(1, 0, 0, 0, 0, -3, 0, geo_camera_main),
				GEO_OPEN_NODE(),
